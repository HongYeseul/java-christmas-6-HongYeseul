...
class OrderDateServiceTest {
    ...
    void inputNormalDate(int input){
        ...
        OrderDateOutputDTO orderDateResponseDTO = orderDateService.inputOrderDate(orderDateInputDTO);
    ...
    void calculateDDaySalePrice(int plannedDate,BigDecimal discount){
        OrderDateOutputDTO orderDateOutputDTO = new OrderDateOutputDTO(plannedDate);
        BigDecimal result = orderDateService.calculateDDaySalePrice(orderDateOutputDTO);
    ...
    void calculateWeekDaySalePrice(int plannedDate,BigDecimal discount){
        OrderDateOutputDTO orderDateOutputDTO = new OrderDateOutputDTO(plannedDate);
        BigDecimal result = orderDateService.calculateWeekDaySalePrice(orderDateOutputDTO, orderMenuOutputDTO);
        assertThat(result).isEqualTo(discount);
    }
    ...
    void calculateWeekendSalePrice(int plannedDate,BigDecimal discount){
        OrderDateOutputDTO orderDateOutputDTO = new OrderDateOutputDTO(plannedDate);
        BigDecimal result = orderDateService.calculateWeekendSalePrice(orderDateOutputDTO, orderMenuOutputDTO);
        assertThat(result).isEqualTo(discount);
    }
    ...
    void calculateSpecialSalePrice(int plannedDate,BigDecimal discount){
        OrderDateOutputDTO orderDateOutputDTO = new OrderDateOutputDTO(plannedDate);
        BigDecimal result = orderDateService.calculateSpecialSalePrice(orderDateOutputDTO);
        assertThat(result).isEqualTo(discount);
    }
}